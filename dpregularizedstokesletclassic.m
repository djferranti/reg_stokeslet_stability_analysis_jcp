function [U2dp, V2dp, W2dp] ...
    = dpregularizedstokesletclassic(C, Kx, Ky, X, Y, Z, ...
...
for j = 1 : numberZlevels 
    ...
    Gfour = Ghat72(C, Kx, Ky, z, epsilon, x0, y0);
    Bfour = Bhat72(C, Kx, Ky, z, epsilon, x0, y0);
    Bprimefour = dBhat72dz(C, Kx, Ky, z, epsilon, x0, y0);
